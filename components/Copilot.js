   ...
   return (
     <Card className="w-full max-w-3xl mx-auto rounded-lg shadow-md">
       <CardHeader className="space-y-2 md:space-y-4">
         ...
         <CardDescription className="text-sm md:text-base text-center md:text-left">Record your voice to interact with the AI assistant</CardDescription>
       </CardHeader>
       
       <CardContent className="space-y-6">
         <div className="flex flex-col md:flex-row justify-center items-center gap-4">
           <Button onClick={isRecording ? stopRecording : startRecording} variant={isRecording ? "destructive" : "default"} disabled={isLoading || isAnalyzing || isSaving} className="w-full md:w-auto min-w-[160px] relative">
         ...
         <div className="space-y-4">
           <div className="min-h-[100px] p-4 bg-muted rounded-lg">
             ...
             <p className="text-sm md:text-base whitespace-pre-wrap">{transcription || 'Your transcribed message will appear here...'}</p>
           </div>
           ...
           <div className="relative min-h-[150px] p-4 bg-muted rounded-lg">
             ...
             <p className="text-sm md:text-base whitespace-pre-wrap">{aiResponse || 'AI response will appear here...'}</p>
           </div>
         </div>
       </CardContent>
     </Card>
